...
const spotLight1 = new THREE.SpotLight(cm2.lightColor, 100000);
...
for (let i = 0; i < numberOfGlass; i++) {
  glassZ.push(-(i * glassUnitSize * 2 - 9 * glassUnitSize));
}
for (let i = 0; i < numberOfGlass; i++) {
...
const preventDragClick = new PreventDragClick(camera);
// 이벤트
